...
type LogEntry struct {
	...
	Index         int32                  `protobuf:"varint,2,opt,name=index,proto3" json:"index,omitempty"`    // Position in the log
	Command       []byte                 `protobuf:"bytes,3,opt,name=command,proto3" json:"command,omitempty"` // The actual command (serialized)
...
const file_proto_raft_proto_rawDesc = "" +
	...
	"\rAppendEntries\x12\x1a.raft.AppendEntriesRequest\x1a\x1b.raft.AppendEntriesResponseB\tZ\a./protob\x06proto3"
